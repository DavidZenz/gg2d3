...
- [x] **GEOM-03
**: Transformed-scale rect/tile edge parity is addressed at the shared scale/axis semantics boundary or carried forward with narrower implementation-ready evidence than the v1.12 classification.
