...
| 44-02-01 | 02 | 2 | POLY-02 | T-44-04, T-44-07 | Renderer source contract avoids invalid SVG attributes and remote/new module APIs | source/unit | `rtk Rscript --vanilla -e 'devtools::load_all(); testthat::test_file("tests/testthat/test-polygon-renderer.R")'` | W0 | pending |
| 44-02-02 | 02 | 2 | POLY-02 | T-44-04, T-44-05, T-44-06, T-44-07 | Renderer emits finite grouped paths, keeps private points underscore-prefixed, and adds only a local module | source/unit | `rtk Rscript --vanilla -e 'devtools::load_all(); testthat::test_file("tests/testthat/test-polygon-renderer.R")'` | W0 | pending |
| 44-02-03 | 02 | 2 | POLY-02 | T-44-04, T-44-05 | Polygon paths update through finite private point arrays without exposing private fields | source/unit | `rtk Rscript --vanilla -e 'devtools::load_all(); testthat::test_file("tests/testthat/test-polygon-renderer.R"); testthat::test_file("tests/testthat/test-zoom-path-datum.R")'` | W0 | pending |
| 44-03-01 | 03 | 3 | POLY-03 | T-44-08, T-44-09, T-44-11 | Tooltip, handler, crosstalk, and brush source paths remain selector-driven and sanitized | source/unit | `rtk Rscript --vanilla -e 'devtools::load_all(); testthat::test_file("tests/testthat/test-polygon-interactivity.R")'` | W0 | pending |
| 44-03-02 | 03 | 3 | POLY-03 | T-44-08, T-44-09, T-44-11 | Existing interaction selector plumbing includes polygons without a polygon-specific callback API | source/unit | `rtk Rscript --vanilla -e 'devtools::load_all(); testthat::test_file("tests/testthat/test-polygon-interactivity.R")'` | W0 | pending |
| 44-03-03 | 03 | 3 | POLY-02, POLY-03 | T-44-08, T-44-10, T-44-12 | Browser smoke proves rendered DOM and sanitized representative payloads with optional clean skips | browser | `rtk Rscript --vanilla -e 'devtools::load_all(); testthat::test_file("tests/testthat/test-polygon-browser.R")'` | W0 | pending |
