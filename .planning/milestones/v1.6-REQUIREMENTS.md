# Requirements Archive: v1.6 Advanced Geoms & API Polish
...
- [x] **API-01**: Developer can use a simplified internal helper for adding new geoms.
- [x] **API-02**: User sees comprehensive documentation for all `d3_*` interactivity functions.
- [x] **PERF-01**: User sees improved rendering performance for plots with >5000 points.
