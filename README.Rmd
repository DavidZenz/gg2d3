...
gg2d3 also supports `geom_sf()` for polygon-family choropleths and polygon
overlays, limited to `POLYGON` and `MULTIPOLYGON` geometries. See the main
vignette for CRS, skipped-row, and map-feature caveats.
