...
- The main and interactivity vignettes provide public examples for Cartesian
  geoms, ordinary polygons, SF maps and annotations, tooltips, hover, zoom,
  brush selection, and linked Crosstalk views.
- The support boundary is intentionally bounded: gg2d3 does not provide tile
  basemaps, slippy controls, JavaScript-side CRS reprojection, topology or
  hole repair, true geometry-overlap brushing, or ggrepel-style placement.
- The examples below describe the supported behavior and the relevant caveats
...
rich text, or path-following annotation placement.
